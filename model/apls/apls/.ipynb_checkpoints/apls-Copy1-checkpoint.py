...
def main():
    ...
    parser.add_argument('--test_method', default='test_geojson_multi', type=str,
            ...
            + "sample truthGeoJson networks" \
            + "'pkl' imports an example ground truth truthGeoJson " \
    ...
    if args.test_method == 'test_geojson_multi':
        ...
        outdir_root = '/home/data/lixg/road/logs/out_dir/'
        truth_dir = '/home/data/lixg/road/labels_geojson/'
        prop_dir = '/home/data/lixg/road/logs/prop_geojson/'
        ...
        for f in name_list:
            ...
            outroot = f.split('.')[0]
            print( "\n\noutroot:", outroot)
            prop_file= os.path.join(truth_dir, f)
            gt_file = os.path.join(prop_dir, outroot + '.geojson')
    ...
    if args.test_method == 'test_geojson':
        outroot = 'test0'
        gt_file = os.path.join(path_apls, 'sample_data/sample_geojson/img1325_gt.truthGeoJson')
        prop_file = os.path.join(path_apls, 'sample_data/sample_geojson/img1325_prop.truthGeoJson')
        ...
        # use truthGeoJson and pkl files
        ...
        gt_file = os.path.join(path_apls, 'sample_data/pkl/OSMroads_img1447.truthGeoJson')
